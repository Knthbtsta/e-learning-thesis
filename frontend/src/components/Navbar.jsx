...
const Navbar = () => {
  ...
  return (
    ...
    >
      <nav
        className={`relative max-w-7xl w-full h-[70px] sm:h-[100px] lg:h-[120px]  mx-auto px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8 transition-all duration-300 ${
          size === "lg" ? "py-2" : "py-3"
        }`}
        aria-label="Global"
      >
