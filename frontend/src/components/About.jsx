...
const About = () => {
  return (
    <div>
      ...
      <div
        id="about"
        className="sm:h-full flex flex-col items-center justify-center text-center xl:h-full bg-orange-100 "
      >
        <div className="text-black text-4xl uppercase font-bold text-center leading-[4rem] md:text-5xl xl:text-7xl md:p-5 md:tracking-wide md:leading-12 md:text-center px-[50px] pt-[50px] md:px-3 xl:pt-[150px] md:pt-10">
          <p>Welcome to Menu</p>
        </div>
        <div className="flex md:flex-col px-[50px] pt-2 text-center text-md text-black text-md font-light leading-6  tracking-widest md:text-lg xl:text-3xl xl:w-1/2 xl:pt-10 md:leading-6">
          <p>
        ...
        <div className="flex flex-col md:flex-row items-center justify-center m-10 gap-10 md:gap-1 lg:gap-10 pb-12">
          <div className="flex flex-col h-[33rem] md:h-[30rem] lg:h-[34rem] group-hover:scale-[0.85] hover:!scale-100 cursor-pointer text-center text-white font-semi text-2xl md:text-md md:ml-2 md:mr-2  bg-cyan-600 rounded-3xl md:w-[230px] xl:w-[350px]  shadow-lg shadow-amber-600 hover:shadow-amber-500">
            <img
              src={img1}
              alt=""
